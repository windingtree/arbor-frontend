                        ...
                        <Grid item container spacing={4} className={classes.stepsCardsWrapper}>
                            <Box item width={"100%"}>
                                <Card className={classes.stepsCard}>
                                    ...
                                    <Typography className={classes.stepCountText}>Step 1.</Typography>
                            ...
                            <Box item width={"100%"}>
                                <Card className={classes.stepsCard}>
                                    <img src={insuranceIcon} alt={'icon'}/>
                                    <Typography className={classes.stepCountText}>Step 2.</Typography>
                                    <Typography className={classes.stepTex}>
                            ...
                            <Box item width={"100%"}>
                                <Card className={classes.stepsCard}>
                                    <img src={insuranceIcon} alt={'icon'}/>
                                    <Typography className={classes.stepCountText}>Step 3.</Typography>
                                    <Typography className={classes.stepTex}>
