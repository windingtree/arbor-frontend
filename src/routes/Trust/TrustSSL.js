            ...
            <div className={classes.topDiv}>
                <Container className={classes.topSectionWrapper}
                    ...
                    <Grid item style={{width: '42%'}}>
                        <div><Typography className={classes.mainTitle} variant={'h1'}>Verify your legal
                            entity </Typography>
            ...
            <div className={classes.verifiedAutoSectionDiv}>
                <Container>
                    <Grid container justify={'space-around'} alignItems={'center'}
                        ...
                        <Grid item className={classes.trustEvIllustrationWrapper}>
